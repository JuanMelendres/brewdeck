...
1. Slice C — account UX: email verification, password reset, refresh tokens, profile. (Slice B per-user ownership fully shipped: B.1 write-path stamping + B.2 read isolation + owner_id NOT NULL.)
