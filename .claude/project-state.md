...
1. Slice C.2 — password reset (mail port + reset-token table). Then C.3 email verification (shares mail infra), C.4 refresh tokens. (C.1 profile + password change shipped on feature/auth-account-profile.)
